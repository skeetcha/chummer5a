    ...
    public class AddImprovementCollection
    {
        ...
        public void addgear(XmlNode bonusNode)
        {
            ...
            Gear Purchase(XmlNode gearNode, Gear parent = null, bool addToCharacter = true)
            {
                ...
                XmlNode node = XmlManager.Load("gear.xml",_objCharacter.Options.CustomDataDictionary).SelectSingleNode("/chummer/gears/gear[name = " + strName.CleanXPath() + " and category = " + strCategory.CleanXPath() + "]");
        ...
        public void addweapon(XmlNode bonusNode)
        {
            ...
            XmlNode node = XmlManager.Load("weapons.xml", _objCharacter.Options.CustomDataDictionary).SelectSingleNode("/chummer/weapons/weapon[name = \"" + strName + "\"]") ?? throw new AbortedException();
        ...
        public void selectcyberware(XmlNode bonusNode)
        {
            ...
            // Display the Select Item window and record the value that was entered.
            string strCategory = bonusNode["category"]?.InnerText;
            XmlNodeList objXmlNodeList = XmlManager.Load("cyberware.xml",_objCharacter.Options.CustomDataDictionary).SelectNodes(!string.IsNullOrEmpty(strCategory)
        ...
        public void optionalpowers(XmlNode bonusNode)
        {
            ...
            // Record the improvement.
            XmlNode objXmlPowerNode = XmlManager.Load("critterpowers.xml", _objCharacter.Options.CustomDataDictionary).SelectSingleNode("/chummer/powers/power[name = \"" + frmPickPower.SelectedPower + "\"]");
        ...
        public void limitspiritcategory(XmlNode bonusNode)
        {
            ...
            using (XmlNodeList xmlSpirits = XmlManager.Load("traditions.xml",_objCharacter.Options.CustomDataDictionary).SelectNodes("/chummer/spirits/spirit"))
