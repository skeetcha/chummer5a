    ...
    public partial class frmCreate : CharacterShared
    {
        ...
        private void frmCreate_Load(object sender, EventArgs e)
        {
            ...
            if (CharacterObject.BuildMethod == CharacterBuildMethod.Priority || CharacterObject.BuildMethod == CharacterBuildMethod.SumtoTen)
            {
                ...
                XmlNode objXmlGameplayOption = XmlManager.Load("gameplayoptions.xml", CharacterObject.Options.CustomDataDictionary).SelectSingleNode("/chummer/gameplayoptions/gameplayoption[name = \"" + CharacterObject.GameplayOption + "\"]");
...
#region Custom Methods
        ...
        public bool CheckCharacterValidity(bool blnUseArgBuildPoints = false, int intBuildPoints = 0)
        {
            ...
            if (intContactPointsUsed > CharacterObject.ContactPoints)
                strMessage += Environment.NewLine + '\t' + string.Format(LanguageManager.GetString("Message_InvalidPointExcess"), ((CharacterObject.ContactPoints - intContactPointsUsed) * -1).ToString(GlobalOptions.CultureInfo) + LanguageManager.GetString("String_Space", GlobalOptions.Language) + LanguageManager.GetString("String_Contacts"));
            */
