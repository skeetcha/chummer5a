...
namespace Chummer
{
    public partial class frmCreatePACKSKit : Form
    {
        ...
        private void cmdOK_Click(object sender, EventArgs e)
        {
            ...
            if (XmlManager.Load("packs.xml", _objCharacter.Options.CustomDataDictionary, GlobalOptions.Language).SelectSingleNode("/chummer/packs/pack[name = " + strName.CleanXPath() + " and category = \"Custom\"]") != null)
            {
